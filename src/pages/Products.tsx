...
import {
  ...
  Edit, Trash2, Copy, Archive, Eye, Tag, Boxes
} from 'lucide-react';
    ...
    <Card hover className="group overflow-hidden p-0">
      <div className="aspect-video bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center space-x-2">
          <button className="p-2 bg-white dark:bg-gray-800 rounded-lg hover:scale-110 transition-transform">
            <Eye size={18} className="text-gray-900 dark:text-white" />
          </button>
          <button className="p-2 bg-white dark:bg-gray-800 rounded-lg hover:scale-110 transition-transform">
            <Edit size={18} className="text-gray-900 dark:text-white" />
          </button>
          <button className="p-2 bg-white dark:bg-gray-800 rounded-lg hover:scale-110 transition-transform">
            <Copy size={18} className="text-gray-900 dark:text-white" />
          </button>
        </div>
      </div>
          ...
          <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between text-xs">
              ...
              <span className={`font-medium ${
                product.low_stock_threshold && product.quantity_on_hand <= product.low_stock_threshold
        ...
        {filteredProducts.length === 0 ? (
          ...
          <Card className="overflow-hidden p-0">
            <table className="w-full">
              <thead className={theme === 'soft-modern' ? "bg-white/50 border-b border-gray-200" : "bg-gray-50 dark:bg-gray-700/50 border-b border-gray-200 dark:border-gray-700"}>
                <tr>
